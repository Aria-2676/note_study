...
class WarehousePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (final item in provider.purchasedItems) {
    ...
    return Scaffold(
      ...
      body: provider.purchasedItems.isEmpty
          ? Center(
              child: Column(
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildWarehouseItemCard(context, entry.key, entry.value, provider);
              },
            ),
    );
  }

  Widget _buildWarehouseItemCard(BuildContext context, String name, List<dynamic> items, AppProvider provider) {
              ...
              children: [
                SizedBox(
                  ...
                  child: Stack(
                    children: [
                      if (count > 1)
                        Positioned(left: 8, top: 0, child: Container(width: 48, height: 48, decoration: BoxDecoration(color: color.withOpacity(0.4), borderRadius: BorderRadius.circular(12), border: Border.all(color: color.withOpacity(0.6), width: 2)))),
                      if (count > 2)
                        Positioned(left: 4, top: 4, child: Container(width: 48, height: 48, decoration: BoxDecoration(color: color.withOpacity(0.6), borderRadius: BorderRadius.circular(12), border: Border.all(color: color.withOpacity(0.8), width: 2)))),
                      Positioned(
                        left: 0, top: count > 1 ? 8 : 4,
                        child: Container(
                          width: 52, height: 52,
                          decoration: BoxDecoration(color: color.withOpacity(0.2), borderRadius: BorderRadius.circular(12), border: Border.all(color: color, width: 2), boxShadow: [BoxShadow(color: color.withOpacity(0.3), blurRadius: 8, offset: const Offset(0, 4))]),
                      ...
                      if (count > 1)
                        Positioned(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(color: color, borderRadius: BorderRadius.circular(12), boxShadow: [BoxShadow(color: color.withOpacity(0.4), blurRadius: 4)]),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(firstItem.description, style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.7), fontSize: 13), maxLines: 2, overflow: TextOverflow.ellipsis),
                    ],
                  ),
                ),
              ],
              ...
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: () => _showItemDetails(context, name, items, provider),
                ...
                ElevatedButton.icon(
                  onPressed: () => _confirmDeleteOne(context, items.last, provider),
  ...
  void _showItemDetails(BuildContext context, String name, List<dynamic> items, AppProvider provider) {
          ...
          children: [
            ...
            ...items.map((item) => ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () async {
                  await provider.deletePurchasedItem(item.id!);
  ...
  Future<void> _confirmDeleteOne(BuildContext context, dynamic item, AppProvider provider) async {
    ...
    if (confirmed == true) await provider.deletePurchasedItem(item.id!);
  }
}
