...
class WarehousePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (final item in provider.shop.purchasedItems) {
    ...
    return Scaffold(
      ...
      body: provider.shop.purchasedItems.isEmpty
          ? Center(
              child: Column(
              ...
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: () =>
                        _showItemDetails(context, name, items, provider),
                ...
                ElevatedButton.icon(
                  onPressed: () =>
                      _confirmDeleteOne(context, items.last, provider),
                ...
                .map(
                  (item) => ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () async {
                        await provider.shop.deletePurchasedItem(item.id!);
  ...
  Future<void> _confirmDeleteOne(
    ...
    if (confirmed == true) await provider.shop.deletePurchasedItem(item.id!);
  }
}
